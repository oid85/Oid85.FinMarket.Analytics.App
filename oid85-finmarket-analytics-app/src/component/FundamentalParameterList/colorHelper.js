...
export const peColor = (value) => {
    ...
    if (value < 0) { return CONSTANTS.COLOR_RED }
    if (value > 0 && value <= 5) { return CONSTANTS.COLOR_GREEN }
    if (value > 5 && value <= 7) { return CONSTANTS.COLOR_YELLOW }
...
export const evEbitdaColor = (value) => { 
    ...
    if (value < 0) { return CONSTANTS.COLOR_RED }
    if (value > 0 && value <= 3.5) { return CONSTANTS.COLOR_GREEN }
    if (value > 3.5 && value <= 5) { return CONSTANTS.COLOR_YELLOW }
