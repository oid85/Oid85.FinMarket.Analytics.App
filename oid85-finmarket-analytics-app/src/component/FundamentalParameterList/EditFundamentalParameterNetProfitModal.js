                ...
                <Modal
                    ...
                    <form>
                        ...
                        <input 
                            ...
                            placeholder='2022 г.' 
                            onChange={ (event) => { 
                                dispatch(fetchCurrentFundamentalParameter({...currentFundamentalParameter, nNetProfit2022: event.target.value})) 
                                }} />    
                        <input 
                            className='form-control edit-modal-input' 
                            type="number" 
                        ...
                        <input 
                            ...
                            placeholder='2025 г.' 
                            onChange={ (event) => { 
                                dispatch(fetchCurrentFundamentalParameter({...currentFundamentalParameter, netProfite2025: event.target.value})) 
                                }} />                                                                                                                                                                          
                        <button 
