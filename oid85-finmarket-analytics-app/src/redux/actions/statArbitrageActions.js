...
export const sagaPortfolioRegressionTail = () => {
    return {
        type: SAGA_PORTFOLIO_REGRESSION_TAIL
    }
}

export const fetchPortfolioRegressionTail = (data) => {
    return {
        type: FETCH_PORTFOLIO_REGRESSION_TAIL,
        payload: data
    }
}
