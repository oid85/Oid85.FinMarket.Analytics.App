...
export const showEditFundamentalParameterDividendModal = () => {
    return {
        type: SHOW_EDIT_FUNDAMENTAL_PARAMETER_DIVIDEND_MODAL
    }
}

export const hideEditFundamentalParameterDividendModal = () => {
    return {
        type: HIDE_EDIT_FUNDAMENTAL_PARAMETER_DIVIDEND_MODAL
    }
}

export const showEditFundamentalParameterMoexModal = () => {
    return {
        type: SHOW_EDIT_FUNDAMENTAL_PARAMETER_MOEX_MODAL
    }
}

export const hideEditFundamentalParameterMoexModal = () => {
    return {
        type: HIDE_EDIT_FUNDAMENTAL_PARAMETER_MOEX_MODAL
    }
}
